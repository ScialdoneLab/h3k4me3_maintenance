...
#cols_clustered = setNames(c("#6ca239","#6bc7ab", "#c2ffd3", "#004414","#f2c237","#e17e39","#b73a2f","#5f91c1","#3b4ca8","grey"), names(chip_clustering))
...
g <- arrangeGrob(res_width[[1]], res_width[[2]], res_width[[3]], res_width[[4]], 
                 res_mean[[1]], res_mean[[2]], res_mean[[3]], res_mean[[4]],
                  ...
                  ncol=4)
ggsave(file=paste0(groups, "_maintenance.pdf"), g, width = 25, height = 6)
```
