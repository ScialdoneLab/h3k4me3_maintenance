...
pdf(file="chip_legend.pdf", width=10, height=3)
plot.new()
#plot(NULL, ,xaxt='n',yaxt='n',bty='n',ylab='',xlab='', xlim=0:1, ylim=0:1)
legend("center", title="H3K4me3", bty = "n",
groups, fill=cols_chipdyns[groups], ncol = 5)
dev.off()
...
```{r}
library(eulerr)
euler_cols <- setNames(rep("#FFFFFF", 16), chip_names_complete)
...
plot_alluvial <- function(remove_NNNN, remove_YYYY){
  ...
  ggplot(plot_df,
    ...
    scale_fill_manual(values=euler_cols) + guides(fill="none")
}
