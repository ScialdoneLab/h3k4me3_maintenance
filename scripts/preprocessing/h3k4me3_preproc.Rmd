...
# Merged data
H3K4me3_spermatid_raw <- enrichment(H3K4me3_spermatid.cov, "Spermatid Merged Reps", value_name=expression("H3K4me3 [log"[2]*"]"))

# Individual replicates (optional)
# H3K4me3_spermatid.rep1 <- enrichment(H3K4me3_spermatid.cov1, "Spermatid Rep1", value_name=expression("H3K4me3 [log"[2]*"]"))
# H3K4me3_spermatid.rep2 <- enrichment(H3K4me3_spermatid.cov2, "Spermatid Rep2", value_name=expression("H3K4me3 [log"[2]*"]"))
# H3K4me3_spermatid.rep3 <- enrichment(H3K4me3_spermatid.cov3, "Spermatid Rep3", value_name=expression("H3K4me3 [log"[2]*"]"))
...
# Merged data
H3K4me3_sperm_raw <- enrichment(H3K4me3_sperm.cov, "Sperm Merged Reps", value_name=expression("H3K4me3 [log"[2]*"]"))

# Individual replicates (optional)
# H3K4me3_sperm.rep1 <- enrichment(H3K4me3_sperm.cov1, "Sperm Rep1", value_name="H3K4me3 [log2], value_name=expression("H3K4me3 [log"[2]*"]"))
# H3K4me3_sperm.rep2 <- enrichment(H3K4me3_sperm.cov2, "Sperm Rep2", value_name="H3K4me3 [log2], value_name=expression("H3K4me3 [log"[2]*"]"))
# H3K4me3_sperm.rep3 <- enrichment(H3K4me3_sperm.cov3, "Sperm Rep3", value_name="H3K4me3 [log2], value_name=expression("H3K4me3 [log"[2]*"]"))
...
# Merged data
H3K4me3_prezga_raw <- enrichment(H3K4me3_prezga.cov, "256c Merged Reps", value_name=expression("H3K4me3 [log"[2]*"]"))

# Individual replicates (optional)
# H3K4me3_prezga.rep1 <- enrichment(H3K4me3_prezga.cov1, "256c Rep1", value_name=expression("H3K4me3 [log"[2]*"]"))
# H3K4me3_prezga.rep2 <- enrichment(H3K4me3_prezga.cov2, "256c Rep2", value_name=expression("H3K4me3 [log"[2]*"]"))
...
# Merged data
H3K4me3_zga_raw <- enrichment(H3K4me3_zga.cov, "St10.5 Merged Reps", value_name=expression("H3K4me3 [log"[2]*"]"))

# Individual replicates (optional)
# H3K4me3_zga.rep1 <- enrichment(H3K4me3_zga.cov1, "St10.5 Rep1", value_name=expression("H3K4me3 [log"[2]*"]"))
# H3K4me3_zga.rep2 <- enrichment(H3K4me3_zga.cov2, "St10.5 Rep2", value_name=expression("H3K4me3 [log"[2]*"]"))
