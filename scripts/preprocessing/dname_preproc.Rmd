...
DNAme_spermatid <- enrichment(spermatid_cov, "DNAme Spermatid", mode="coverage", value_name=expression("DNAme [log"[2]*"]"))
```
...
DNAme_sperm <- enrichment(sperm_cov, "DNAme Sperm", value_name=expression("DNAme [log"[2]*"]"))
```
...
DNAme_pre_zga <- enrichment(pre_zga_cov, "DNAme Pre-ZGA", value_name=expression("DNAme [log"[2]*"]"))
```
