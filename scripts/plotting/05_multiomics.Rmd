...
chip_dfs[["Spermatid"]]$promoter.dna.methyl <- DNAme_dfs[["Spermatid"]]$promoter.mean
...
chip_dfs[["Pre-ZGA"]]$promoter.accessibility <- accessibility_dfs[["Pre-ZGA"]]$promoter.mean
...
pre_zga_data <- list("H3K4me3" = h3k4stages[["Pre-ZGA"]], "DNAme" = DNAme_stages[["Pre-ZGA"]], "Accessibility" = accessibility_stages[["Pre-ZGA"]])
