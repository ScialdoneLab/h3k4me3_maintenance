...
expression.data = list("6hpf"=expression.6hpf, "7hpf"=expression.7hpf, "8hpf"=expression.8hpf, "9hpf"=expression.9hpf)
...
#plot_data$Category <- factor(plot_data$Category, levels=c("GS", "GZ", "ZS", "ND"))
