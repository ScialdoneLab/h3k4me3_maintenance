...
get_zga_genes <- function(stringent=FALSE){
  ...
  return(unique(chen[zga_nascent.detected, "name"]))
}
 
zga_nascent.detected_stringent <- get_zga_genes(stringent = TRUE)
zga_nascent.detected_lenient <- get_zga_genes(stringent = FALSE)
