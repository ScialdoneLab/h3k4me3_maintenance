...
#rna_clustering <- list(Zygotic = c("Zonly", "MZonly", "PZonly", "MPZ"), NonZygotic = c("Monly", "Ponly", "MPonly", "ND"))
#cols_rna_clusters <- c(Zygotic="#9636d1", NonZygotic="#b7eb34")
...
zga_nascent.6hpf_lenient = (chen[,"GSM6076952"] - chen[,"GSM6076950"]) > Z_thr_lenient | (chen[,"GSM6076953"] - chen[,"GSM6076951"]) > Z_thr_lenient |     
                    (chen[,"GSM6076976"] - chen[,"GSM6076974"]) > Z_thr_lenient | (chen[,"GSM6076977"] - chen[,"GSM6076975"]) > Z_thr_lenient
zga_nascent.7hpf_lenient = (chen[,"GSM6076954"] - chen[,"GSM6076950"]) > Z_thr_lenient | (chen[,"GSM6076955"] - chen[,"GSM6076951"]) > Z_thr_lenient | 
                    (chen[,"GSM6076978"] - chen[,"GSM6076974"]) > Z_thr_lenient | (chen[,"GSM6076979"] - chen[,"GSM6076975"]) > Z_thr_lenient
zga_nascent.8hpf_lenient = (chen[,"GSM6076956"] - chen[,"GSM6076950"]) > Z_thr_lenient | (chen[,"GSM6076957"] - chen[,"GSM6076951"]) > Z_thr_lenient |
                    (chen[,"GSM6076980"] - chen[,"GSM6076974"]) > Z_thr_lenient | (chen[,"GSM6076981"] - chen[,"GSM6076975"]) > Z_thr_lenient
zga_nascent.9hpf_lenient = (chen[,"GSM6076958"] - chen[,"GSM6076950"]) > Z_thr_lenient | (chen[,"GSM6076959"] - chen[,"GSM6076951"]) > Z_thr_lenient | 
                    (chen[,"GSM6076982"] - chen[,"GSM6076974"]) > Z_thr_lenient | (chen[,"GSM6076983"] - chen[,"GSM6076975"]) > Z_thr_lenient
...
expression.9hpf = ((chen[,"GSM6076958"] - chen[,"GSM6076950"]) + (chen[,"GSM6076959"] - chen[,"GSM6076951"]) +
                    (chen[,"GSM6076982"] - chen[,"GSM6076974"]) + (chen[,"GSM6076983"] - chen[,"GSM6076975"])) /4
expression.9hpf[expression.9hpf < 0] = 0
names(expression.9hpf) <- chen$name
expression.9hpf <- expression.9hpf[allgenes$gene_id]

zga_nascent.6hpf <- unique(chen[zga_nascent.6hpf_stringent, "name"])
zga_nascent.7hpf <- unique(chen[zga_nascent.7hpf_stringent & !zga_nascent.6hpf_stringent, "name"])
zga_nascent.8hpf <- unique(chen[zga_nascent.8hpf_stringent & !zga_nascent.7hpf_stringent & !zga_nascent.6hpf_stringent, "name"])
zga_nascent.9hpf <- unique(chen[zga_nascent.9hpf_stringent & !zga_nascent.8hpf_stringent & !zga_nascent.7hpf_stringent & !zga_nascent.6hpf_stringent, "name"])
```
...
if (tolower(response) == "yes") {
  if(clustered_rna_groups){
    save(rna_dyns, cols_rnadyns, expression.9hpf, file="rna_data_clustered.RData")
  } else {
    save(rna_dyns, cols_rnadyns, expression.9hpf, file="rna_data.RData")
  }
} else {
