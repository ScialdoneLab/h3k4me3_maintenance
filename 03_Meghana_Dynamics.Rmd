...
```{r fig.height=5, fig.width=10}
plot(plot_stage_dynamics("ZGA", type="expression.6hpf", groups, legend=TRUE))
plot(plot_stage_dynamics("ZGA", type="expression.7hpf", groups, legend=TRUE))
plot(plot_stage_dynamics("ZGA", type="expression.8hpf", groups, legend=TRUE))
